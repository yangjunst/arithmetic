//---------------------------------------------------------------------
// WarGame.java             by Dale/Joyce/Weems               Chapter 4
//
...
//{
//  QueueInterface<Integer> player1;   // player 1's hand
//  QueueInterface<Integer> player2;   // player 2's hand
//
...
//
//  QueueInterface<Integer> prize;  // cards for current battle
//
...
//    player1 = new ArrayBoundedQueue<Integer>(numCards);
//    player2 = new ArrayBoundedQueue<Integer>(numCards);
//
//    // instantiate prize pile
//    prize = new ArrayBoundedQueue<Integer>(numCards);
//
